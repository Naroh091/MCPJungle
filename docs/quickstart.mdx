...
If you're running locally in development mode, you can also open the built-in UI at:
...
If you prefer a browser-based control surface for local usage, open the [development UI](/guides/dev-ui) to inspect servers, tools, prompts, resources, and tool groups.
